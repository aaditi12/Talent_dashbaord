  ...
  <div class="modal fade" id="myModal" role="dialog" style="background-color: #F8F8F8;">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style="background-color: #F8F8F8; color: white; ">
              ...
              <form role="form" action="" method="post" autocomplete="off">
                <div class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-3">
                      <button type="submit" class="btn btn-default btn-sm rounded-0" data-dismiss="modal" style="color: #E65200;">Cancel</button>
                    </div>
                  </div>
                </div>
              </form> 
